...
public class Opcodes {
    ...
    public void LD(int intoRegister, int value){System.out.println("load value into intoRegister");}

    // increment the register
    public void INC(int register){System.out.println("increment register");}

    // decrement register
    public void DEC(int register){System.out.println("decrement register");}

    // right rotates bits in A
    public void RRCA(){System.out.println("RRCS");}

    // stop cpu
    public void STOP(){System.out.println("STOP");}

    // jump the amount of the value passed in
    public void JR(int value){System.out.println("jump" + value);}

    // add the value of addRegister into intoRegister and store it in intoRegister
    public void ADD(int intoRegister, int addRegister){System.out.println("add");}

    // right shift register
    public void RR(int register){System.out.println("right shit" + register);}

    // jump if zero flag is not set the amount that is passed in e.g. r8
    public void JRNZ(int value){System.out.println("jump" + value);};

    // load loadRegister into incRegister then increment incRegister
    public void LDINCFIRST(int incRegister, int loadRegister){System.out.println("load then inc register");}

    // decimal adjust register
    public void DA(int register){System.out.println("decimal addjust " + register);}

    // jump if zero flag is set
    public void JRZ(int offset){System.out.println("Jump not zero" + offset);}

    // load loadRegister into intoRegister then increment loadRegister
    public void LDINCSECOND(int intoRegister, int loadRegister){System.out.println("Load " + loadRegister + " into " +
            intoRegister +  "then increment "+ loadRegister);}

    // load loadRegister into intoRegister then decrement into
    public void LDDECFIRST(int intoRegister, int loadRegister){System.out.println("");}

    // set carry flag
    public void SFC(){System.out.println("");}

    // jump if the carry flag is set
    public void JRC(){System.out.println("");}

    // load loadRegister into intoRegister then decrement loadRegister
    public void LDDECSECOND(int intoRegister, int loadRegister){System.out.println("");}

    // compliment carry flag
    public void CCF(){System.out.println("");}

    // halt cpu temporarily?
    public void HALT(){System.out.println("");}

    // add the second register to the first register with the carry flag and store it in the first register
    public void ADC(int intoRegister, int loadRegister){System.out.println("");}

    // subtracts contents of register passed in and puts result in A and sets the carry, zero, and negative flags
    public void SUB(int A, int register){System.out.println("");}

    // AND A with register passed in
    public void AND(int A, int register){System.out.println("");}

    // XOR A with register passed in
    public void XOR(int A, int register){System.out.println("");}

    // compare contents of a register with A, sets flags, but does not modify either
    public void CP(int A, int register){System.out.println("");}

    // pops value of top of stack and stores it into the register specified
    public void POP(int register){System.out.println("");}

    // push contents of a register onto the stack
    public void PUSH(int register){System.out.println("");}

    // software reset. Moves the program counter to the start of the program by loading it with 0x00
    public void RST(){System.out.println("");}
    ...
    // call a specific routine in memory located as address passed in e.g. 0x08 that pushes the address of the next instruction
    // onto the stack and transfers program control to the specified routine
    public void RST(int address){}

    // return to the address at the top of the stack if 0 flag is not set
    // or return control to the calling routine if zero flag is not set. or are these the same thing?
    public void RETNZ(){}
    ...
    // subtracts contents of the register and the carry flag from A stores it in A and updates the carry, zero, and half carry
    // flag
