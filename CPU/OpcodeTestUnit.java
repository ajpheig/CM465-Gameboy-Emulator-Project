...
//    ReadGBFC parent;// null
//    InterruptManager intMan = new InterruptManager();
//    Memory mem = new Memory(romData, "null");// non functional
//    CPU cpu = new CPU(romData, regs, intMan, mem, parent);
